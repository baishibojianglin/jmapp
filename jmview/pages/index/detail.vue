		...
		<vrow>
			<vcol span="100">
				<view class="contentcss">
					<u-parse :content="content.content" userSelect="none" />
				</view>
			</vcol>
		</vrow>
	</view>
...
<style>
	...
	.borbottom {
		background: -webkit-linear-gradient(left, #82858A, #695648);
		/* Safari 5.1 - 6.0 */
		background: linear-gradient(left, #82858A, #0F2822);
		/*chrom*/
		background: -ms-linear-gradient(left, #82858A, #695648);
		/* IE 10 */
		background: -moz-linear-gradient(left, #82858A, #695648);
		/*火狐*/
		background: -o-linear-gradient(left, #82858A, #695648);
		/* Opera 11.1 - 12.0 */
	}
